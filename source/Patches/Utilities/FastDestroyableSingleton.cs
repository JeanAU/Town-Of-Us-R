// This is part of the TheOhterRoles, Licensed under GNU General Public License v3.0
// file="FastDestroyableSingleton.cs" company="TheOhterRolesAU">
using System;
...
public static unsafe class FastDestroyableSingleton<T> where T : MonoBehaviour
{
    ...
    public static T Instance
    {
        get
        {
            ...
            if (objectPointer == IntPtr.Zero) return FastDestroyableSingleton<T>.Instance;
